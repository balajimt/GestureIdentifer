...
def skinMask(frame):
    ...
    # rgb(80, 244, 66) Green
    cv2.putText(frame,'Skin Mask',(gc.xROI,gc.yROI-20), gc.font, gc.size,(80,244,66),1,1)
...
def binaryMask(frame):
    # Color orange
    cv2.putText(frame,'Binary Threshold',(gc.xROI,gc.yROI-20), gc.font, gc.size,(80,244,66),1,1)
    cv2.rectangle(frame, (gc.xROI,gc.yROI),(gc.xROI+gc.widthROI,gc.yROI+gc.heightROI),(80,244,66),1)
    roi = frame[gc.yROI:gc.yROI+gc.heightROI, gc.xROI:gc.xROI+gc.widthROI]
